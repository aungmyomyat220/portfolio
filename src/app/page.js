    ...
    <>
      {
        panel?
          ...
          <div className={'text-xl flex flex-col'}>
              <Link href='#about' className={`animate-fade-up animate-once animate-duration-[1000ms] animate-delay-300 border ${theme==='dark'? 'border-white': 'border-black'} mb-5 px-20 py-2 text-center`} onClick={()=>setPanel(false)}>Home</Link>
